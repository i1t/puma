...
public class Http11 extends RubyObject {
    ...
    public final static int MAX_REQUEST_URI_LENGTH = 1024 * 1024;
    public final static String MAX_REQUEST_URI_LENGTH_ERR = "HTTP element REQUEST_URI is longer than the 1048576 allowed length.";
    ...
    public final static int MAX_QUERY_STRING_LENGTH = 1024 * 1024;
    public final static String MAX_QUERY_STRING_LENGTH_ERR = "HTTP element QUERY_STRING is longer than the 1048576 allowed length.";
